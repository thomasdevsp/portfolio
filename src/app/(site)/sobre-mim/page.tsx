...
export default function SobreMim() {
  ...
  const handleHistoryButton = () => {
    window.location.replace("blog/Minha-Jornada-com-a-Tecnologia-Da-Curiosidade-Carreira-25b9a45e7f1180008f27fcc40a094490");
    sendEnrichedGAEvent({
      eventName: "Sobre mim",
      params: {
        action: "Ler história completa",
      }
    });
  }
